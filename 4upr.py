...
class Ball:
    def __init__(self, screen: pygame.Surface, x=40, y=450, ball_type="normal"):
        self.screen = screen
        self.x = x
        self.y = y
        if ball_type == "big":
            self.r = randint(15, 30)
        elif ball_type == "small":
            self.r = randint(5, 15)
        else:
            self.r = randint(5, 30)
        self.vx = 0
...
class Gun:
    ...
    def fire2_end(self, event):
        ...
        if self.f2_power > 15:
            ball_type = "big"
        elif self.f2_power < 5:
            ball_type = "small"

        new_ball = Ball(self.screen, ball_type=ball_type)
        new_ball.r += 5
        self.an = math.atan2(
